...
@Service
public class WaterLvlEventsListner implements SerialPortEvents {

    private final Logger logger = LoggerFactory.getLogger(WaterLvlEventsListner.class);
    ...
    public void onMessage(String values, ReadingType type) {
        if (type == ReadingType.ALERT) {
            ...
            logger.info("actual waterlvl value :- "+values +" transformed value :- "+val);
